...
.wrapper .container .text article a.btn {
  padding: 10px 30px;
  border-radius: 50px;
  cursor: pointer;
  box-shadow: 0px 15px 20px rgba(62, 92, 163, 0.5);
  z-index: 3;
  color: #695681;
...
.wrapper .container .text article a.btn:hover {
  box-shadow: 0px 10px 10px -10px rgba(62, 92, 163, 0.5);
...
.wrapper .container .circle:before {
  ...
  width: 800px;
  height: 800px;
  background-color: rgba(62, 92, 163, 0.2);
  border-radius: 100%;
  top: 50%;
  left: 50%;
  transform: translate(-50%, -50%);
  box-shadow: inset 5px 20px 40px rgba(62, 92, 163, 0.25), inset 5px 0px 5px rgba(100, 141, 176, 0.3), inset 5px 5px 20px rgba(100, 141, 176, 0.25), 2px 2px 5px rgba(255, 255, 255, 0.2);
...
.wrapper .container .one .content:before {
  ...
  width: 600px;
  height: 600px;
  background-color: rgba(62, 92, 163, 0.3);
  border-radius: 100%;
  box-shadow: inset 5px 20px 40px rgba(62, 92, 163, 0.25), inset 5px 0px 5px rgba(100, 141, 176, 0.3), inset 5px 5px 20px rgba(100, 141, 176, 0.25), 2px 2px 5px rgba(255, 255, 255, 0.2);
...
.wrapper .container .three .content .piece:nth-child(3) {
  ...
  animation-delay: 4.5s;
    ...
    <nav>
        <div class="menu">
            <p class="website_name"><?=get_custom_logo()?></p>
        </div>
    </nav>
        ...
        <div class="container">
            ...
            <div class="text">
                <article>
                    ...
                    <a class='btn' href='<?=get_site_url()?>'>i dare!</a>
                </article>
            </div>
